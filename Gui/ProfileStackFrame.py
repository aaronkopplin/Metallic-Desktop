...
class ProfileStackFrame(QFrame):
    def __init__(self):
        ...
        self.my_profile_button.setIcon(QIcon("Gui/icons/single_profile_icon.png"))
        ...
        self.other_profile_button.setIcon(QIcon("Gui/icons/friends_icon.png"))
        ...
        # profile widget
        self.my_profile = Profile("Gui/icons/profilepic.png", "Aaron Kopplin", "@aaronkopplin", "0.0765", "143", "1 year 6 mos")
        self.stack.addWidget(self.my_profile)

        # other profile
        self.other_profile = Profile("Gui/icons/vitalik.png", "Test", "Test", "Test", "Test", "Test")
